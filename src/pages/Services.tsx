import { Ship, Cog, Trash2, Building, Truck, Wrench, ArrowRight, CheckCircle } from "lucide-react";
  ...
  const services = [
    {
      ...
      compliance: ["Hong Kong Convention", "EU Ship Recycling Regulation", "Basel Convention"]
    },
    {
      icon: Building,
      title: "Ship Building",
    ...
    },
    {
      ...
      compliance: ["TSDF Standards", "Environmental Protection Act", "Waste Management Rules"]
    },
    {
      icon: Cog,
      ...
      description: "Our electric-arc-furnace mill is where community ambition meets industrial innovation. Processing up to 60,000 TPA of reclaimed ship steel, we produce top-grade rebars, structural sections, and specialty billets—all under an ISO 14001-certified process with full chain-of-custody transparency.",
      features: [
      ...
      capacity: "60,000 TPA",
      compliance: ["ISO 14001", "Chain-of-Custody Certification", "Quality Standards"]
    },
    {
      icon: Truck,
      ...
      description: "Spread across 100 acres, our logistics park is more than forklifts and warehouses—it's a lifeline for local enterprise. Covered stacking yards, bonded facilities, and direct links to national highways and the Chennai–Kolkata rail corridor mean smoother operations and swift dispatch.",
      features: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1585076641399-5c06d1b3365f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      description: "When ships need care, Neptunus steps in with heart and expertise. Our service quay—backed by 350,000 m³ dredging capacity, four tug/push boats, and eight specialized service craft—offers everything from hull inspections to emergency overhauls.",
      features: [
        ...
        <div className="container-custom py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/services" className="text-body text-primary">Services</a>
                ...
                <div className={`grid lg:grid-cols-2 gap-0 ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                  ...
                  <div className={`p-8 lg:p-12 ${index % 2 === 1 ? 'lg:col-start-1' : ''}`}>
                    <div className="space-y-6">
                      <div>
                        <div className="text-caption text-brand-blue mb-2">{service.subtitle}</div>
                      ...
                      <div className="bg-background/50 p-6 rounded-lg">
                        <div className="flex items-center justify-between mb-4">
                          <h3 className="text-body-large font-semibold text-text-primary">Key Features</h3>
                      ...
                      <div>
                        <h3 className="text-body-large font-semibold text-text-primary mb-3">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-headline font-bold text-text-primary mb-6">
              Why Choose Neptunus Services?
            </h2>
            <p className="text-title text-text-secondary">
              Our integrated approach ensures maximum value recovery, environmental protection, and community benefit
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Zero Waste", desc: "100% material recovery and safe disposal", icon: "♻️" },
              { title: "Global Standards", desc: "Full compliance with international regulations", icon: "🌍" },
              { title: "Local Impact", desc: "Creating jobs and supporting communities", icon: "🏘️" },
              { title: "Innovation", desc: "Cutting-edge technology and processes", icon: "⚡" }
            ].map((benefit, index) => (
