import { Ship, Building2, DollarSign, Users, Scale, Globe, Building, ArrowRight, CheckCircle } from "lucide-react";
  ...
  const stakeholderGroups = [
    {
      ...
      keyFeatures: ["Full IHM Certification", "40% Credit Notes", "Zero Beaching Risk", "HKGS & EUSSR Compliant"]
    },
    {
      ...
      keyFeatures: ["Digital Chain-of-Custody", "Certified Quality", "EAF Processing", "ESG Compliance"]
    },
    {
      ...
      keyFeatures: ["UN Certification", "Government Support", "Guaranteed Market", "Strategic Positioning"]
    },
    {
      ...
      keyFeatures: ["Zero-Accident Pledge", "70% Local Hire Target", "Training Programs", "Community Infrastructure"]
    },
    {
      ...
      keyFeatures: ["Real-time Dashboards", "Third-party Audits", "Basel/UNEP Alignment", "Partnership Model"]
    },
    {
      ...
      keyFeatures: ["Global Collaboration", "R&D Innovation", "Thought Leadership", "Impact Amplification"]
    },
    {
      ...
      keyFeatures: ["Industrial Cluster", "Budget Leverage", "Legislative Alignment", "PPP Model"]
    }
  ];
        ...
        <div className="container-custom py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/stakeholders" className="text-body text-primary">Stakeholders</a>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-title text-text-secondary">
              Neptunus creates a win-win ecosystem where environmental responsibility meets economic opportunity
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Economic Growth", desc: "Creating jobs and driving prosperity", icon: "📈", value: "₹3B+ GDP" },
              { title: "Environmental Impact", desc: "Reducing carbon emissions", icon: "🌱", value: "8.35M tCO₂" },
              { title: "Social Development", desc: "Community uplift and safety", icon: "🤝", value: "22K+ Jobs" },
              { title: "Innovation Leadership", desc: "Global standards and practices", icon: "🚀", value: "World-Class" }
            ].map((metric, index) => (
              <Card key={index} className="glass-panel text-center p-6">
                <div className="text-4xl mb-4">{metric.icon}</div>
                <div className="text-body-large font-bold text-primary mb-2">
                  {metric.value}
                </div>
